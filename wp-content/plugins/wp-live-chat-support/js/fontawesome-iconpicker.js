...
(function(a) {
    ...
    c.defaultOptions.icons = ["fas fa-bolt","fas fa-book","fas fa-chart-area","fas fa-check","fas fa-check-circle","fas fa-clock","fas fa-cloud",
        "fas fa-code","fas fa-code-branch","fas fa-cog","fas fa-comment-dots","fas fa-comments","fas fa-ellipsis-h","fas fa-ellipsis-v",
        "far fa-envelope","fas fa-exclamation","fas fa-eye","fas fa-gavel","fas fa-info-circle","fas fa-lock","fas fa-newspaper",
        "far fa-paper-plane","fas fa-paperclip","fas fa-pencil-alt","fas fa-question-circle","fas fa-search",
        "fas fa-server","fas fa-sliders-h","fas fa-smile","fas fa-tasks","fas fa-times","fas fa-university","fas fa-user-times","fas fa-users"
    ];
});