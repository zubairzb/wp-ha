  ...
  <div class="slider-wrapper theme-default">
    <div id="slider" class="nivoSlider">
        ...
        while ( $query->have_posts() ) : $query->the_post();
          $i++;
          $photoshoot_lite_slideno[] = $i;
          $photoshoot_lite_slidetitle[] = get_the_title();
		  $photoshoot_lite_slidedesc[] = get_the_excerpt();
          $photoshoot_lite_slidelink[] = esc_url(get_permalink());
          ?>
        ...
        <?php
        $k = 0;
        foreach( $photoshoot_lite_slideno as $photoshoot_lite_sln ){ ?>
    <div id="slidecaption<?php echo esc_attr( $photoshoot_lite_sln ); ?>" class="nivo-html-caption">
      <div class="top-bar">
        <h2><a href="<?php echo esc_url($photoshoot_lite_slidelink[$k] ); ?>"><?php echo esc_html($photoshoot_lite_slidetitle[$k] ); ?></a></h2>
        <p><?php echo esc_html($photoshoot_lite_slidedesc[$k] ); ?></p>
        <div class="clear"></div>
        <a class="slide-button" href="<?php echo esc_url($photoshoot_lite_slidelink[$k] ); ?>">
          <?php echo esc_html(get_theme_mod('slide_text',__('Read More','photoshoot-lite')));?>
          </a>
      </div>
    </div>
 	<?php $k++;
